...
void image( hpx::parallel::spmd_block block, std::string filename, int test_count, std::size_t grain_factor, int unroll_factor)
{
    spmatrix a(filename);
...
int hpx_main(boost::program_options::variables_map& vm)
{
    ...
    auto localities = hpx::find_all_localities();
    hpx::parallel::define_spmd_block( "block", localities, image_action(), filename, test_count, grain_factor, unroll_factor).get();
