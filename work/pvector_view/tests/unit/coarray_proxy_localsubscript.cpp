...
int main()
{
    auto image_coarray =
        [](hpx::parallel::spmd_block block)
        {
            ...
            hpx::coarray<double,3,std::vector<double>> a
                = { block, "a", {height,width,_}, std::vector<double>(4, 0.0) };
            ...
            for (std::size_t i = 0; i<height; i++)
            {
                ...
                a.data(i,j,_) = std::vector<double>(4,idx);
                idx++;
            }
